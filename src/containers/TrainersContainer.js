    ...
    render() {
        ...
        return (
            <div>
                ...
                <div className="trainers gap">
                    <Trainer showActions={()=>this.showActions()} visible={this.state.visible}/>
                </div>
            </div>
        );
    }
...
export default connect(mapStateToProps, null)(TrainersContainer);
